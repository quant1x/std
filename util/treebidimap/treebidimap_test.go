...
func TestMapPut(t *testing.T) {
	m := NewWith(internal.IntComparator, internal.StringComparator)
	m.Put(5, "e")
	m.Put(6, "f")
	m.Put(7, "g")
	m.Put(3, "c")
...
func TestMapEach(t *testing.T) {
	m := NewWith(internal.StringComparator, internal.IntComparator)
	m.Put("c", 3)
	m.Put("a", 1)
	m.Put("b", 2)
	count := 0
...
func TestMapSerialization(t *testing.T) {
	for i := 0; i < 10; i++ {
		original := NewWith(internal.StringComparator, internal.StringComparator)
		original.Put("d", "4")
		original.Put("e", "5")
		original.Put("c", "3")
		original.Put("b", "2")
		...
		deserialized := NewWith(internal.StringComparator, internal.StringComparator)
